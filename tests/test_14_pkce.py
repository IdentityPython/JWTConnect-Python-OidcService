...
class TestPKCE256:
    ...
    def test_add_code_challenge_default_values(self):
        ...
        _state_key = auth_serv.service_context.state.create_state(iss="Issuer")
    ...
    def test_authorization_and_pkce(self):
        auth_serv = self.service["authorization"]
        _state = auth_serv.service_context.state.create_state(iss='Issuer')
    ...
    def test_access_token_and_pkce(self):
        ...
        authz_service.service_context.state.store_item(auth_response, 'auth_response', _state)
