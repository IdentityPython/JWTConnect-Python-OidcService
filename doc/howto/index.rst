...
The :py:class:`oiccli.service.Service` class contains all the necessary
methods for creating an RP/client request and to parse an OP/AS response.

Furthermore it uses the :py:class:`oiccli.client_info.ClientInfo` class
...
:py:class:`oiccli.client_info.ClientInfo` instance is initiated for every
